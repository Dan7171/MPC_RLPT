...
class rlptAgent:       
    ...
    def update_etl(self, st, action_id,rt,ep_num,ts,at_meta_data,contact_detected,step_duration,ee_pos_error, ee_rot_error,etl_file_path,forced_stopping, optim_meta_data, goal_reached):
        ...
        new_row = [ep_num, ts, at_meta_data['q(w,st,all)'], at_meta_data['q(w,st,at)'], at_id, *st_at, step_duration, rt, ee_pos_error, ee_rot_error, contact_detected, goal_reached, forced_stopping]
