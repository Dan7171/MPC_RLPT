    ...
    def optimize(self, rlpt_agent):
        ...
        for t in range(T):
            ...
            for g_tag in G:
                ...
                s_next_is_terminal_wrt_new_goal = transition_info['s_next_contact_detected'] or goal_test(s_next_ee_pos_error_wrt_new_goal, s_next_ee_rot_error_wrt_new_goal) 
